...
CREATE TABLE `deletedMemberTBL` (
  `memberID` char(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `memberName` char(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `memberAddress` char(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `deletedMemberTBL` VALUES ('Dang','당탕이','경기 부천시 중동','2021-11-01');
...
CREATE TABLE `memberTBL` (
  `memberID` char(8) COLLATE utf8_unicode_ci NOT NULL,
  `memberName` char(5) COLLATE utf8_unicode_ci NOT NULL,
  `memberAddress` char(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_deletedMemberTBL
	AFTER DELETE 
	ON memberTBL
	FOR EACH ROW 
BEGIN
...
CREATE TABLE `productTBL` (
  `productName` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `cost` int(11) NOT NULL,
  `makeDate` date DEFAULT NULL,
  `company` char(5) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Temporary table structure for view `uv_membertbl`
--
...
/*!50001 CREATE TABLE `uv_membertbl` (
  `memberName` tinyint NOT NULL,
  `memberAddress` tinyint NOT NULL
) ENGINE=MyISAM */;
...
/*!50001 DROP TABLE IF EXISTS `uv_membertbl`*/;
/*!50001 DROP VIEW IF EXISTS `uv_membertbl`*/;
...
-- Dump completed on 2021-11-02  0:56:27
